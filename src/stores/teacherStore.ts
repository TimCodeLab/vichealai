...
export const useTeacherStore = defineStore('teacher', () => {
  ...
  async function fetchTeachers(schoolId: string) {
    ...
    try {
      ...
      console.warn('Failed to fetch teachers, using mock data:', err.message)
      teachers.value = [
        { id: 'teacher_1', schoolId, userId: 'user_1', employeeId: 'TEA001', firstName: 'John', lastName: 'Doe', gender: 'male', dateOfBirth: '1985-06-15', qualification: 'B.Sc Mathematics', specialization: 'Mathematics', phone: '0123456789', email: 'john.doe@school.com', address: '100 Teacher Lane', hireDate: '2015-01-01', salary: 50000, status: 'active', createdAt: new Date().toISOString() },
        { id: 'teacher_2', schoolId, userId: 'user_2', employeeId: 'TEA002', firstName: 'Jane', lastName: 'Smith', gender: 'female', dateOfBirth: '1988-03-20', qualification: 'B.A English', specialization: 'English', phone: '0123456790', email: 'jane.smith@school.com', address: '200 Teacher Lane', hireDate: '2016-06-01', salary: 48000, status: 'active', createdAt: new Date().toISOString() }
      ]
    } finally {
      loading.value = false
    }
  ...
  async function fetchAssignments(schoolId: string) {
    ...
    try {
      ...
      console.warn('Failed to fetch assignments, using mock data:', err.message)
      assignments.value = [
        { id: 'assign_1', schoolId, teacherId: 'teacher_1', sectionId: 'class_1', subjectId: 'subj_1', academicYearId: 'year_1' },
        { id: 'assign_2', schoolId, teacherId: 'teacher_2', sectionId: 'class_1', subjectId: 'subj_2', academicYearId: 'year_1' }
      ]
    } finally {
      loading.value = false
    }
