...
const routes: Array<RouteRecordRaw> = [
  ...
  {path: '/timetable', component: () => import('@/pages/academic/Timetable.vue'), meta: {requiresAuth: true}},
  {path: '/parents', component: () => import('@/pages/academic/Parents.vue'), meta: {requiresAuth: true}},
  {path: '/communication', component: () => import('@/pages/communication/Communication.vue'), meta: {requiresAuth: true}},
  ...
  {path: '/school-register', component: () => import('@/pages/register/SchoolRegister.vue'), meta: {requiresAuth: false}},
