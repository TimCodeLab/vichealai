      ...
      <div class="s-body anim-fade-up">
        ...
        >
          ...
          <div class="s-profile-info">
            <div class="s-profile-name">
              {{ userName }}
            </div>
            <div class="s-profile-role">
          ...
          <div class="s-group">
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.theme') }}</span>
              </div>
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.language') }}</span>
              </div>
              <div class="s-lang-toggle">
                <button
                  :class="['s-lang-btn', { active: currentLang === 'km' }]"
                ...
                <button
                  :class="['s-lang-btn', { active: currentLang === 'en' }]"
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.fontSize') }}</span>
              </div>
              <div class="s-font-tabs">
                <button
                  v-for="sz in fontSizes"
                  :key="sz.value"
                  :class="['s-font-btn', { active: fontSize === sz.value }]"
                  @click="fontSize = sz.value"
                >
                  {{ sz.label }}
                </button>
              </div>
          ...
          <div class="s-group">
            ...
            >
              <div class="s-row">
                ...
                >
                  <div class="s-toggle-knob" />
                </div>
              </div>
              <div
                v-if="idx < notifItems.length - 1"
                class="s-divider s-divider-indent"
              />
            </div>
          </div>
        </div>
          ...
          <div class="s-group">
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.school') }}</span>
              </div>
              <span class="s-row-value">Royal Academy</span>
            </div>
            <div class="s-divider s-divider-indent" />
            <div class="s-row">
              <div class="s-row-left">
                <div
                  class="s-icon-wrap"
                ...
                <span class="s-row-label">{{ t('settings.academicYear') }}</span>
              </div>
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.semester') }}</span>
              </div>
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.timezone') }}</span>
              </div>
          ...
          <div class="s-group">
            ...
            >
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.changePassword') }}</span>
              </div>
              <svg
                width="16"
                height="16"
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.twoFactor') }}</span>
              </div>
              <div
                class="s-toggle"
                :class="{ on: twoFactor }"
          ...
          <div class="s-group">
              ...
              <div class="s-row-left">
                ...
                >
                  <svg
                    ...
                    fill="none"
                  ><path
                    d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15h-1v-6h1v6zm0-8h-1V7h1v2z"
                    fill="#1976d2"
                  /></svg>
                </div>
                <span class="s-row-label">{{ t('settings.appVersion') }}</span>
              </div>
              ...
              <div class="s-row-left">
                ...
                >
                  <svg
                    ...
                    fill="none"
                  ><path
                    d="M9 12h6M9 16h6M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l5 5v11a2 2 0 0 1-2 2z"
                    stroke="#9333ea"
                    stroke-width="2"
                    stroke-linecap="round"
                  /></svg>
                </div>
                <span class="s-row-label">{{ t('settings.build') }}</span>
              </div>
            ...
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('forms.schoolCode') }}</span>
              </div>
          ...
          <div class="s-group">
            <div class="s-row">
              <div class="s-row-left">
                ...
                <span class="s-row-label">{{ t('settings.offlineMode') }}</span>
              </div>
              <div
                class="s-toggle"
                :class="{ on: offlineMode }"
        ...
        <div class="s-app-footer">
          ...
          <div class="s-app-name">
            techocam
          </div>
          <div class="s-app-tagline">
            {{ t('app.subtitle') }}
          </div>
          <div class="s-app-copy">
            © 2025 techocam. All rights reserved.
          </div>
        </div>
...
const notifItems = computed(() => [
  {key: 'announcements', icon: '📢', label: t('settings.notifAnnounce'), sub: t('settings.notifAnnounceSub'), bg: '#eff6ff'},
  {key: 'homework', icon: '📝', label: t('settings.notifHomework'), sub: t('settings.notifHomeworkSub'), bg: '#f0fdf4'},
  {key: 'exams', icon: '📊', label: t('settings.notifExams'), sub: t('settings.notifExamsSub'), bg: '#fef9c3'},
  {key: 'fees', icon: '💳', label: t('settings.notifFees'), sub: t('settings.notifFeesSub'), bg: '#fff7ed'},
]);
