...
<style scoped>
.pg-header { background:linear-gradient(135deg,#c62828 0%,#e53935 45%,#ef5350 100%); box-shadow:0 4px 20px rgba(198,40,40,.4); }
...
.pg-search:focus-within { border-color:#c62828; }
...
.pg-empty-btn { margin-top:16px; padding:10px 24px; background:#c62828; color:white; border:none; border-radius:10px; font-size:14px; font-weight:600; cursor:pointer; }
...
.pg-avatar { width:46px; height:46px; border-radius:50%; color:white; font-size:19px; font-weight:700; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
...
.mo-input:focus { border-color:#c62828; background:white; }
...
.mo-save   { flex:2; padding:13px; background:linear-gradient(135deg,#c62828,#e53935); color:white; border:none; border-radius:12px; font-size:14px; font-weight:600; cursor:pointer; }
