        ...
        <div class="pg-body anim-fade-up">
          ...
          >
            ...
            <div style="font-size:13px;color:#9ca3af;margin-top:4px">
              Go to Classes and add a class first
            </div>
          </div>
          ...
          >
            ...
            <div class="cls-pick-info">
              <div class="cls-pick-name">
                {{ cls.name }}
              </div>
              <div class="cls-pick-sub">
                {{ classStudentCount(cls.id) }} students
                <span
                  v-if="classHasRecord(cls.id)"
                  class="cls-done-badge"
                >✓ Done</span>
              </div>
            </div>
            <svg
      ...
      <ion-content style="--background:#f5f7fa">
        <div class="pg-body anim-fade-up">
          ...
          >
            ...
            <div style="font-size:13px;color:#9ca3af;margin-top:4px">
              Assign students to {{ selectedClass.name }} first
            </div>
          </div>
