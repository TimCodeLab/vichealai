  ...
  <ion-page>
      ...
      <div class="pg-body anim-fade-up">
        ...
        <div class="tab-row">
          ...
          >
            {{ tab.icon }} {{ tab.label }}
            <span
              v-if="tab.val !== 'all' && tabCount(tab.val) > 0"
              class="tab-count"
            >{{ tabCount(tab.val) }}</span>
          </button>
        </div>
        ...
        >
          ...
          <div style="font-size:16px;font-weight:600;color:#374151">
            {{ t('communication.noNotifTitle') }}
          </div>
          <div style="font-size:13px;color:#9ca3af;margin-top:4px">
            {{ t('communication.noNotif') }}
          </div>
          <button
            class="pg-empty-btn"
            @click="openCreate"
          >
            + {{ t('communication.createAnnounce') }}
          </button>
        </div>
        ...
        >
          ...
          <div class="notif-body">
            ...
            <div class="notif-footer">
              <span
                class="notif-badge"
                :style="{ background: typeColorLight(item.type), color: typeColorDark(item.type) }"
              >
                {{ typeLabel(item.type || 'general') }}
              </span>
              <span
                v-if="item.targetRole"
                class="notif-badge notif-badge-gray"
    ...
    >
      <div class="mo-wrap">
        ...
        <div class="mo-body">
          <div class="mo-field">
            <label class="mo-label">{{ t('communication.titleLabel') }} *</label><input
              v-model="form.title"
              class="mo-input"
          ...
          <div class="mo-field">
            <label class="mo-label">{{ t('communication.contentLabel') }} *</label><textarea
            ...
            <div class="mo-field">
              ...
              >
                <option value="general">
                  📢 {{ t('communication.typeGeneral') }}
                </option>
                <option value="academic">
                  📚 {{ t('communication.typeAcademic') }}
                </option>
                <option value="event">
                  🎉 {{ t('communication.typeEvent') }}
                </option>
                <option value="urgent">
                  🚨 {{ t('communication.typeUrgent') }}
                </option>
                <option value="holiday">
                  🏖 {{ t('communication.typeHoliday') }}
                </option>
                <option value="exam">
                  📝 {{ t('communication.typeExam') }}
                </option>
              </select>
            </div>
            <div class="mo-field">
              ...
              >
                <option value="all">
                  {{ t('communication.everyone') }}
                </option>
                <option value="students">
                  {{ t('communication.targetStudents') }}
                </option>
                <option value="teachers">
                  {{ t('communication.targetTeachers') }}
                </option>
                <option value="parents">
                  {{ t('communication.targetParents') }}
                </option>
              </select>
            </div>
          </div>
